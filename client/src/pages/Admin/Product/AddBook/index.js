  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      try {
        ...
        // Kiểm tra nếu là lỗi Redis
        if (error.message?.includes('ECONNREFUSED') || error.message?.includes('Redis error')) {
          // Nếu có response data, nghĩa là request vẫn thành công
